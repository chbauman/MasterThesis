...
def try_opcua(verbose: int = 0):
    ...
    curr_control = [
        (475, ToggleController(val_low=10, val_high=35, n_mins=60 * 8, start_low=True, max_n_minutes=60 * 24)),
        (571, ToggleController(val_low=10, val_high=35, n_mins=60 * 8, start_low=True)),
    ]
